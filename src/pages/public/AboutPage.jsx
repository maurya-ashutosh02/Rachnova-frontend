    ...
    <PublicLayout>
      ...
      <section className="pt-32 pb-20 bg-dark-950 relative overflow-hidden">
        ...
        <div className="container-custom relative">
          ...
          <h1 className="section-heading text-5xl md:text-7xl mb-6">
            {about?.title || "About Rachnova"}
          </h1>
              ...
              <div className="relative">
                {about.aboutImage ? (
                  ...
                  <div className="w-full h-80 bg-dark-800 border border-dark-700 flex items-center justify-center">
                    <div className="font-heading text-7xl text-primary-600/20">
                      R
                    </div>
                  </div>
                )}
                {about.yearsOfExperience && (
                  <div className="absolute -bottom-5 -right-5 w-28 h-28 bg-primary-600 flex flex-col items-center justify-center">
                    <div className="font-heading text-white text-3xl">
                      {about.yearsOfExperience}+
                    </div>
                    <div className="text-primary-100 text-xs text-center font-mono mt-1">
                      YRS EXP
                    </div>
                  </div>
                )}
          ...
          <div className="container-custom">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {about.coreValues.map((val, i) => (
                <div
                  key={i}
                  className="card p-6 text-center hover:border-primary-700/50 transition-colors"
                >
          ...
          <div className="container-custom">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {about.whyChooseUs.map((item, i) => (
                <div
                  key={i}
                  className="flex gap-5 p-6 border border-dark-800 hover:border-primary-700/50 transition-colors group"
                >
          ...
          <div className="container-custom">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div>
                ...
                <h2 className="font-heading text-4xl text-white tracking-wider mb-2">
                  {about.founderName}
                </h2>
                <p className="text-primary-500 font-mono text-sm tracking-widest uppercase mb-6">
                ...
                {about.expertise?.length > 0 && (
                  <div className="mt-6 flex flex-wrap gap-2">
                    {about.expertise.map((e, i) => (
                      <span
                        key={i}
                        className="text-xs font-mono px-3 py-1.5 border border-primary-800 text-primary-400 uppercase tracking-wider"
                      >
                        {e}
                      </span>
                    ))}
      ...
      <section className="py-16 bg-dark-950 border-t border-dark-800">
        <div className="container-custom text-center">
          <h3 className="font-heading text-3xl text-white tracking-wider mb-4">
